FROM mambaorg/micromamba:2.4.0 AS builder
...
RUN micromamba create -n essential postgresql git make curl -c conda-forge -y &&\
    ...
    micromamba create -n py314 python==3.14.* -c conda-forge -y
...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    PATH=/code/.venv/bin:/opt/conda/envs/py314/bin:/code/.venv/bin:/opt/conda/envs/py313/bin:/code/.venv/bin:/opt/conda/envs/py312/bin:/opt/conda/envs/py311/bin:/opt/conda/envs/py310/bin:/opt/conda/envs/essential/bin:/opt/circleci/.poetry/bin:$PATH

RUN curl -sSL https://install.python-poetry.org | /opt/conda/envs/py314/bin/python -
